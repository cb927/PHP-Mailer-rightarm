...
<body>
    ...
    <main>
        <div class="main__step">
            ...
            <a href="#!" class="step__item active" id="step-link4">
                <span>
                    STEP04 <br>
                    テクノロジー
                </span>
            ...
            <div class="fit-content">
                ...
                <div class="content__main">
                    <div class="main__btns">
                        <div class="btn__line">
                            <div class="btn__item">AI<span style="display: none;">,</span></div>
                            <div class="btn__item">RPA<span style="display: none;">,</span></div>
                            <div class="btn__item">VR/AR/MP<span style="display: none;">,</span></div>
                            <div class="btn__item">loT<span style="display: none;">,</span></div>
                        </div>
                        <div class="btn__line">
                            <div class="btn__item">ERP<span style="display: none;">,</span></div>
                            <div class="btn__item">ブロックチェーン<span style="display: none;">,</span></div>
                            <div class="btn__item">ビックデータ<span style="display: none;">,</span></div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#next').click(function() {
                var step4 = '';
                step4 = $('.main__content--pc .btn__item.active').text();
                if (step4 != '') {
                    localStorage.setItem('step4', step4);
            ...
            $('#next-sp').click(function() {
                var step4 = '';
                step4 = $('.main__content--sp .btn__item.active').text();
                if (step4 != '') {
                    localStorage.setItem('step4', step4);
                    location.href = 'step5.php';
                } else {
