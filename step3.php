...
<body>
    ...
    <main>
        <div class="main__step">
            ...
            <a href="#!" class="step__item active" id="step-link3">
                <span>
                    STEP03 <br>
                    スキル
                </span>
            ...
            <div class="fit-content">
                ...
                <div class="content__main">
                    <div class="main__btns">
                        <div class="btn__line">
                            <div class="btn__item">Java<span style="display: none;">,</span></div>
                        ...
                        <div class="btn__line">
                            ...
                            <div class="btn__item">ネットワーク系<span style="display: none;">,</span></div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#next').click(function() {
                var step3 = '';
                step3 = $('.main__content--pc .btn__item.active').text();
                if (step3 != '') {
            ...
            $('#next-sp').click(function() {
                var step3 = '';
                step3 = $('.main__content--sp .btn__item.active').text();
                if (step3 != '') {
                    localStorage.setItem('step3', step3);
                    location.href = 'step4.php';
                } else {
    ...
    <script>
        $(document).ready(function() {
            ...
            if ((step4 == '' && step3 == '') || (step4 == null && step3 == null)) {
